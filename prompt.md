===
commit: 14962f25, Add Excel processing pipeline for Russian educational reports
===
...
===
commit: 233d7bf8, Add parallel processing to Excel sheet export
===
...
===
commit: 02d8f50f, Add real-time progress tracking to Excel sheet export
===
...
===
commit: da489a3d, Add header extraction step to Excel processing pipeline
===
...
===
commit: eff1c89f, Add workbook merge step to Excel processing pipeline
===
...
===
commit: fb25684e, Skip empty rows and section delimiters in CRC hash calculation
===
...
===
commit: ebbf6ed4, Normalize header heights during workbook merge
===
...
===
commit: 4ebb70d2, Add library extraction and header removal step to pipeline
===
...
===
commit: 63eb07d6, Add SQL bundle generation step to Excel processing pipeline
===
...
===
commit: b393172d, Add database import step to pipeline
===
...
===
commit: f9779db6, Add regional workbook merging step to pipeline
===
...
===
commit: 377ff6ee, Preserve zero-padded formatting when reading Excel cells
===
...
===
commit: 4b80ebdd, Add workbook-to-SQL conversion step to pipeline
===
